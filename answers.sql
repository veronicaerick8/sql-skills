...
SELECT models.name, models.brand_name, brands.headquarters FROM models JOIN brands ON models.brand_name=brands.name WHERE models.brand_name ='Ford' and models.name='Mustang';
...
SELECT models.name, models.brand_name, brands.founded FROM models INNER JOIN brands ON brands.name = models.brand_name;
